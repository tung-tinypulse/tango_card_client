...
# Unit tests for SwaggerClient::1CustomersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe '1CustomersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::1CustomersApi.new
  end
  ...
  describe 'test an instance of 1CustomersApi' do
    it 'should create an instance of 1CustomersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::1CustomersApi)
    end
  end
