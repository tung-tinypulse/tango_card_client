...
# Unit tests for SwaggerClient::OrderListItemView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderListItemView' do
  before do
    # run before each test
    @instance = SwaggerClient::OrderListItemView.new
  end
  ...
  describe 'test an instance of OrderListItemView' do
    it 'should create an instance of OrderListItemView' do
      expect(@instance).to be_instance_of(SwaggerClient::OrderListItemView)
    end
  end
