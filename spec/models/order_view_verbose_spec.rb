...
# Unit tests for SwaggerClient::OrderViewVerbose
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderViewVerbose' do
  before do
    # run before each test
    @instance = SwaggerClient::OrderViewVerbose.new
  end
  ...
  describe 'test an instance of OrderViewVerbose' do
    it 'should create an instance of OrderViewVerbose' do
      expect(@instance).to be_instance_of(SwaggerClient::OrderViewVerbose)
    end
  end
