...
# Unit tests for SwaggerClient::CreateCreditCardCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateCreditCardCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateCreditCardCriteria.new
  end
  ...
  describe 'test an instance of CreateCreditCardCriteria' do
    it 'should create an instance of CreateCreditCardCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateCreditCardCriteria)
    end
  end
