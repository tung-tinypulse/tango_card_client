...
# Unit tests for SwaggerClient::CatalogView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogView' do
  before do
    # run before each test
    @instance = SwaggerClient::CatalogView.new
  end
  ...
  describe 'test an instance of CatalogView' do
    it 'should create an instance of CatalogView' do
      expect(@instance).to be_instance_of(SwaggerClient::CatalogView)
    end
  end
end
