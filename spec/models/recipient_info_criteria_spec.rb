...
# Unit tests for SwaggerClient::RecipientInfoCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientInfoCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientInfoCriteria.new
  end
  ...
  describe 'test an instance of RecipientInfoCriteria' do
    it 'should create an instance of RecipientInfoCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientInfoCriteria)
    end
  end
