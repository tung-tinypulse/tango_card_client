...
# Unit tests for SwaggerClient::SenderInfoCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SenderInfoCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::SenderInfoCriteria.new
  end
  ...
  describe 'test an instance of SenderInfoCriteria' do
    it 'should create an instance of SenderInfoCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::SenderInfoCriteria)
    end
  end
