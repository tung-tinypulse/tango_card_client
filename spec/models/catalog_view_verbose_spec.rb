...
# Unit tests for SwaggerClient::CatalogViewVerbose
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogViewVerbose' do
  before do
    # run before each test
    @instance = SwaggerClient::CatalogViewVerbose.new
  end
  ...
  describe 'test an instance of CatalogViewVerbose' do
    it 'should create an instance of CatalogViewVerbose' do
      expect(@instance).to be_instance_of(SwaggerClient::CatalogViewVerbose)
    end
  end
