...
# Unit tests for SwaggerClient::CreateCustomerCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateCustomerCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateCustomerCriteria.new
  end
  ...
  describe 'test an instance of CreateCustomerCriteria' do
    it 'should create an instance of CreateCustomerCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateCustomerCriteria)
    end
  end
