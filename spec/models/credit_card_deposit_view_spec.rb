...
# Unit tests for SwaggerClient::CreditCardDepositView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditCardDepositView' do
  before do
    # run before each test
    @instance = SwaggerClient::CreditCardDepositView.new
  end
  ...
  describe 'test an instance of CreditCardDepositView' do
    it 'should create an instance of CreditCardDepositView' do
      expect(@instance).to be_instance_of(SwaggerClient::CreditCardDepositView)
    end
  end
