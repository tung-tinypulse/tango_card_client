...
# Unit tests for SwaggerClient::RecipientInfoView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientInfoView' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientInfoView.new
  end
  ...
  describe 'test an instance of RecipientInfoView' do
    it 'should create an instance of RecipientInfoView' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientInfoView)
    end
  end
