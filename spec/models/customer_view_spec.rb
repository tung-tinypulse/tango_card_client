...
# Unit tests for SwaggerClient::CustomerView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerView' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomerView.new
  end
  ...
  describe 'test an instance of CustomerView' do
    it 'should create an instance of CustomerView' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomerView)
    end
  end
end
