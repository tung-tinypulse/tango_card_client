...
# Unit tests for SwaggerClient::CreditCardCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditCardCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CreditCardCriteria.new
  end
  ...
  describe 'test an instance of CreditCardCriteria' do
    it 'should create an instance of CreditCardCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CreditCardCriteria)
    end
  end
