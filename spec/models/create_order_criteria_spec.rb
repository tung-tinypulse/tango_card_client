...
# Unit tests for SwaggerClient::CreateOrderCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateOrderCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateOrderCriteria.new
  end
  ...
  describe 'test an instance of CreateOrderCriteria' do
    it 'should create an instance of CreateOrderCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateOrderCriteria)
    end
  end
