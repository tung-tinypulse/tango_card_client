...
# Unit tests for SwaggerClient::CustomerViewSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerViewSummary' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomerViewSummary.new
  end
  ...
  describe 'test an instance of CustomerViewSummary' do
    it 'should create an instance of CustomerViewSummary' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomerViewSummary)
    end
  end
