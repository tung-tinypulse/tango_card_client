...
module SwaggerClient
  ...
  class OrderViewSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'redemptionInstructions')
        self.redemption_instructions = attributes[:'redemptionInstructions']
      end
    ...
    def hash
      [account_identifier, amount_charged, campaign, created_at, customer_identifier, denomination, email_subject, message, recipient, redemption_instructions, reference_order_id, reward, reward_name, send_email, sender, status, utid].hash
    end
