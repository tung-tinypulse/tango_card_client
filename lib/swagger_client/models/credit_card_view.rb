...
module SwaggerClient
  ...
  class CreditCardView
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastFourDigits')
        self.last_four_digits = attributes[:'lastFourDigits']
      end
    ...
    def hash
      [account_identifier, activation_date, created_date, customer_identifier, expiration_date, label, last_four_digits, status, token].hash
    end
