...
module SwaggerClient
  ...
  class CreditCardDepositView
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'referenceDepositID')
        self.reference_deposit_id = attributes[:'referenceDepositID']
      end
    ...
    def hash
      [amount, amount_charged, created_date, fee_percent, reference_deposit_id, status].hash
    end
