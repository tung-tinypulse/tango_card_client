...
module SwaggerClient
  ...
  class OrderViewVerbose
    ...
    def hash
      [account_identifier, amount_charged, campaign, created_at, customer_identifier, denomination, email_subject, etid, external_ref_id, message, notes, recipient, reference_order_id, reward, reward_name, send_email, sender, status, utid].hash
    end
