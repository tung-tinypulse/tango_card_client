...
module SwaggerClient
  ...
  class AccountView
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'currentBalance')
        self.current_balance = attributes[:'currentBalance']
      end
    ...
    def hash
      [account_identifier, contact_email, created_at, currency_code, current_balance, display_name, status].hash
    end
